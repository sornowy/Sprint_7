...
class TestCourierCreate:
    ...
    def test_courier_success(self):
        ...
        response = requests.post(variables.ApiUrls.COURIER_BASE_URL, json=courier_data)
    ...
    def test_courier_duplicat(self):
        courier_data = generate_courier_data()
        response_1 = requests.post(variables.ApiUrls.COURIER_BASE_URL, json=courier_data)
        ...
        response_2 = requests.post(variables.ApiUrls.COURIER_BASE_URL, json=courier_data)
